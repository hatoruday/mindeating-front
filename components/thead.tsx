    ...
    <div className="w-full">
      <div className="flex mt-2 w-full justify-between max-h-[30px]">
        <div className="w-[40px] relative h-[87px] flex justify-center">
          <p className="text-[12px] font-semibold font-medium text-center text-black2 absolute z-20">Mo</p>
        ...
        <div className="w-[40px] relative flex justify-center">
          <p className="text-[12px] font-semibold font-medium text-center text-black2  z-20">Tu</p>
        ...
        <div className="w-[40px] relative flex justify-center">
          <p className="text-[12px] font-semibold font-medium text-center text-black2  z-20">We</p>
        ...
        <div className="w-[40px] relative flex justify-center">
          <p className="text-[12px] font-semibold font-medium text-center text-black2  z-20">Th</p>
        ...
        <div className="w-[40px] relative flex justify-center">
          <p className="text-[12px] font-semibold font-medium text-center text-black2  z-20">Fr</p>
        ...
        <div className="w-[40px] relative flex justify-center">
          <p className="text-[12px] font-semibold font-medium text-center text-black2  z-20">Sa</p>
        ...
        <div className="w-[40px] relative flex justify-center">
          <p className="text-[12px] font-semibold font-medium text-center text-black2  z-20">Su</p>
