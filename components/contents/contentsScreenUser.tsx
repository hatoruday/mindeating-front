            ...
            <div className="h-full flex flex-col justify-center">
              {width && height ? (
                <div className="flex justify-center content-center items-center h-full w-full">
                  <img src={articleImgSrc} width={width} height={height} alt="aritlcleImage" />
                </div>
              ) : (
                <div className="relative content-center items-center h-full w-full">
                  <img src={articleImgSrc} width={0} height={0} sizes="(max-width: 380px) 30vw, (max-width: 768px) 40vw, 20vw" alt="aritlcleImage" className="w-full h-auto" priority={true} />
                </div>
              )}
            </div>
          )}
