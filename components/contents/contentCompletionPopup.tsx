...
export default function ContentsCompletionPopup({ setOpen, isOpen, fetchSubmit }: { fetchSubmit: any; setOpen: any; isOpen: boolean }) {
  return (
    <Dialog as="div" className={`${FontClassNames} fixed inset-0 z-20 overflow-y-auto`} onClose={() => setOpen(false)} open={isOpen}>
      <div className="min-h-screen px-4 text-center flex justify-center items-center">
        ...
        >
          <Dialog.Title as="h3" className="">
            <span className="text-[18px] font-bold font-noto text-black1">미션 수행 완료!</span>
          </Dialog.Title>
