        ...
        {contentsBlockList.map((contentsBlock, index) => {
          return (
            <React.Fragment key={index}>
              <Link
                className="col-span-6 row-span-3 w-ful"
                href={`${contentsBlock.path}`}
              >
                <ContentsBox
